...
2. يجب أن تكون قيم "status" هي (محقق) أو (غير محقق).
3. يجب أن تكون قيم "depth" هي (تحليلي) أو (وصفي).
4. يجب أن تكون قيمة "grade" هي (امتياز، مرضي جداً، مرضي، أو إخفاق).
...
{
  "score": <رقم بين 0-100>,
  "grade": "التقدير بالعربي",
  "criteria": [
    { "id": "اسم المعيار", "max": 100, "awarded": <رقم>, "status": "محقق/غير محقق", "depth": "تحليلي/وصفي", "desc": "شرح الأسباب بالعربي" }
  ],
